...
void QtAddressBookGUI::createWidgets()
{
    ...
    newContactButton->setStyleSheet("padding : 05px;border-radius:2%;background-color: brown;color:white");
    editContactButton->setStyleSheet("padding : 05px;border-radius:2%;background-color: violet;color:white");
    deleteContactButton->setStyleSheet("padding : 05px;border-radius:2%;background-color: orange;color:white");
