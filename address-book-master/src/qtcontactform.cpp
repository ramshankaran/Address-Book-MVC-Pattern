...
{
    addRow("<font style='color:green'><b>First Name</b></font>", firstNameField);
    addRow("<font style='color:red'>Last Name</font>", lastNameField);
    addRow("<font style='color:blue'>Address</font>", addressField);
    addRow("<font style='color:orange'>Phone Number</font>", phoneNumberField);
    addRow("<font style='color:violet'>Email</font>", emailField);
    addRow("<font style='color:brown'>City</font>",cityField);
}
